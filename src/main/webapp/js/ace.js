(function() {
    ...
    (function() {
        this.onMouseDown = function(e) {
            ...
            return !t || this.$clickSelection || e.getShiftKey() || r.inMultiSelectMode ? this.startSelect(n) : t && (this.mousedownEvent.time = Date.now(), this.startSelect(n)), this.captureMouse(e), e.preventDefault()
            ...
            n ? t.selection.selectToPosition(e) : this.$clickSelection || (t.moveCursorToPosition(e), t.selection.clearSelection()), t.renderer.scroller.setCapture && t.renderer.scroller.setCapture(), t.setStyle("ace_selecting"), this.setState("select")
    ...
    var m = function(e, t) {
        ...
        this.canvas = r.element, this.$markerFront = new a(this.content), this.$cursorLayer = new l(this.content), this.$horizScroll = !1, this.$vScroll = !1, this.scrollBar = this.scrollBarV = new h(this.container, this), this.scrollBarH = new c(this.container, this), this.scrollBarV.addEventListener("scroll", function(e) {
            ...
            n.updateCharacterSize(), n.onResize(!0, n.gutterWidth, n.$size.width, n.$size.height), n._signal("changeCharacterSize")
        }), this.$size = {
            width: 0,
            height: 0,
            scrollerHeight: 0,
    ...
    (function() {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, d), this.updateCharacterSize = function() {
            ...
            this.session = e, this.scrollMargin.top && e.getScrollTop() <= 0 && e.setScrollTop(-this.scrollMargin.top), this.$cursorLayer.setSession(e), this.$markerBack.setSession(e), this.$markerFront.setSession(e), this.$gutterLayer.setSession(e), this.$textLayer.setSession(e), this.$loop.schedule(this.CHANGE_FULL)
    ...
    (function() {
        i.implement(this, o), this.setSession = function(e) {
            ...
            var t = e.firstRow,
                n = e.lastRow,
                i = this.session,
                s = i.getNextFoldLine(t),
                o = s ? s.start.row : Infinity,
                u = this.$showFoldWidgets && i.foldWidgets,
                a = i.$breakpoints,
                f = i.$decorations,
                l = i.$firstLineNumber,
                c = 0,
            ...
            if (this.$fixedWidth || i.$useWrapMode) c = i.getLength() + l;
            var w = h ? h.getWidth(i, c, e) : c.toString().length * e.characterWidth,
    ...
    t.showErrorMarker = function(e, t) {
        ...
        if (f) {
            var c = f[0];
            c.pos && c.column == null && (s.column = c.pos.sc), s.row = c.row, l = e.renderer.$gutterLayer.$annotations[s.row]
        } else {
            if (a) return;
            l = {
                text: ["Looks good!"],
        ...
        d.style.left = v + e.renderer.gutterWidth - 5 + "px", h.el.className = "error_widget_wrapper", p.className = "error_widget " + l.className, p.innerHTML = l.text.join("<br>");
        var m = {
            handleKeyboard: function(e, t, n) {
                if (t === 0 && n === "esc") return h.destroy(), !0
            }
        };
        h.destroy = function() {
        ...
        }, e.keyBinding.addKeyboardHandler(m), e.on("changeSelection", h.destroy), e.on("changeSession", h.destroy), e.on("mouseup", h.destroy), e.on("change", h.destroy), e.session.widgetManager.addLineWidget(h), h.el.onmousedown = e.focus.bind(e)
