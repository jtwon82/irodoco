...
dojo.declare("agsjs.layers.GoogleMapsLayer", esri.layers.Layer, {
    ...
    constructor: function(opts) {
        ...
        this.tileInfo = new esri.layers.TileInfo({
            ...
            dpi: 96,
            origin: {
                x: -2.9061136181539027,
                y: 113.95975118528129
            },
            spatialReference: {
                wkid: 102100
            },
...
//            console.log( 323, google.maps.drawing );
            ...
            var src = pro + '//maps.googleapis.com/maps/api/js?key=AIzaSyB-1M-t9_rbL6ZhYV_Ccq7u6IiIfymbnuU&callback=agsjs.onGMapsApiLoad&libraries=drawing';
    ...
    _extentChangeHandler: function(extent, delta, levelChange, lod) {
		console.log(' _extentChangeHandler : lat=', extent.getCenter().getLatitude() + ", lon="+extent.getCenter().getLongitude());
        if (levelChange) {
    ...
    _opacityChangeHandler: function(opacity) {
    	//console.log(' _opacityChangeHandler');
    ...
    _mapTypeChangeHandler: function() {
    	//console.log(' _mapTypeChangeHandler');
...
require(['esri/dijit/BasemapGallery'], function(BasemapGallery) {
    ...
    dojo.extend(esri.dijit.BasemapGallery, {
        ...
        _processReferenceLayersExt: function(basemap) {
        	//console.log( ' _processReferenceLayersExt' );
            var layers = basemap.getLayers();
            var hasRef = false,
                vis = true;
        ...
        _onSelectionChangeExt: function() {
        	//console.log( ' _onSelectionChangeExt' );
        ...
        _checkSelectedNode: function() {
        	//console.log( ' _checkSelectedNode' );
