           ...
           <div id="admin-index" class='bodycenter' dojotype="dijit.layout.ContentPane" region="center" style='z-index:0;'>
				<div style=''>
					<div class="page-header">
					  <h1>cctv 관리 영상표출활성화<small> </small></h1>
					</div>
				</div>
				<br>
...
<form name="form1" action="/admin-facility-proc" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="bid" value="${ map.bid }">
				...
				<div class="input-group">
				  <span class="input-group-addon" id="basic-addon2">영상표출</span>
				  <select name="MOV_LIVE" data-subname="아이디" class="form-control" aria-describedby="basic-addon2">
				...
				<div style="text-align:right;">
					<div class="btn-group" role="group" aria-label="...">
					  <a href="javascript: document.form1.submit();" class="btn btn-default" role="button">저장</a>
					  <a href="admin-facility?page=${ map.page }" class="btn btn-default" role="button">리스트</a>
					</div>
				</div>
</form>
            </div>
